    ...
    case '随机人设':
      ...
      request(options, function (error, response) {
        if (error) {
          ...
          sbody = response.body;
          // console.log(sbody);
          let strs = ['姓名：','性别：','身高：','年龄：','体重：','爱好：','幸运物：','生日：','职业：','外貌：','对象的名字：','讨厌的东西：','爱吃的东西：','个人的故事背景：','关于幸运物的关联故事：','关于幸运物的故事：','对未来的看法：','未来展望：','姓名:','性别:','身高:','年龄:','体重:','爱好:','幸运物:','生日:','职业:','外貌:','对象的名字:','讨厌的东西:','爱吃的东西:','个人的故事背景:','关于幸运物的关联故事:','关于幸运物的故事:','对未来的看法:','未来展望:','个人故事背景:','个人的故事背景：'];
