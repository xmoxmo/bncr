      ...
      request(options, function (error, response) {
        if (error) {
          ...
          let strs = ['姓名：','性别：','身高：','年龄：','体重：','爱好：','幸运物：','生日：','职业：','外貌：','对象的名字：','讨厌的东西：','爱吃的东西：','个人的故事背景：','关于幸运物的故事：','对未来的看法：','未来展望：',
                      ...
                      '个人故事背景:','个人故事背景：','与对象的故事:','与对象的故事：','个人背景:','幸运物故事:','个人背景：','幸运物故事：','个人故事:','个人故事：','对自己未来的看法：','对自己未来的看法:','对未来的展望：','对未来的展望:'];
          ...
          if (sbody.indexOf('关于幸运物的关联故事：') == -1 && sbody.indexOf('关于幸运物的关联故事:') == -1 && sbody.indexOf('幸运物关联故事：') == -1 && sbody.indexOf('幸运物关联故事:') == -1) {
            strs.push('关联故事：');
            strs.push('关联故事:');
          } else {
